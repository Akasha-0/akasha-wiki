...
### Estudo Comparativo: Ayahuasca vs. Psilocibina (2025)
- **Design:** Comparação direta entre retiros de psilocibina e ayahuasca
- **População:** Veteranos militares com PTSD
...
Trauma → Amígdala hiperativa → Flashbacks, evitação
     ↓
Ayahuasca:
1. Reduz filtro do ego (DMN)
2. Dessensibiliza amígdala gradualmente
3. Permite "reconsolidação" da memória com novo significado
4. Aumenta conectividade com córtex pré-frontal (controle)
```

## Comparação: Ayahuasca vs. Psilocibina

| Indicador | Ayahuasca | Psilocibina |
|-----------|-----------|-------------|
